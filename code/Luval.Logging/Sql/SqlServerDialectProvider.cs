...
namespace Luval.Logging.Sql
{
    ...
    /// </summary>
    public class SqlServerDialectProvider : IDialectProvider
    {
        /// <summary>
        ...
        public string ToSqlInsert(LogMessage logMessage)
        {
            ...
            sb.AppendFormat("VALUES ({0}, {1}, {2}, {3}, {4}, {5}) ",
                ToSql(logMessage.MachineName), ToSql(logMessage.UtcTimestamp), logMessage.MessageType, ToSql(logMessage.Logger), ToSql(logMessage.Message), ToSql(logMessage.Exception));
            return sb.ToString();
        }
